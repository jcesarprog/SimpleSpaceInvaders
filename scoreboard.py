...
class ScoreBoard():
    '''Classe para mostrar informacoes sobre a pontuacao'''

    def __init__(self, ai_settings, screen, stats):
        '''Inicializa os atrubutos da pontuacao'''
        self.screen = screen
        self.screen_rect = screen.get_rect()
        self.ai_settings = ai_settings
        self.stats = stats

        # Configuracoes de fonts para as informacoes de pontuacao
        self.text_color = (30, 30 , 30)
        self.font = pygame.font.SysFont(None, 48)

        # Prepara as pontuacoes iniciais
        self.prep_score()
    ...
    def prep_score(self):
        ...
        # Exibe a pontuacao na parte superior da tela
    ...
    def prep_high_score(self):
        '''Transforma a pontuacao maxima em uma uma imagem renderizada'''
    ...
    def show_score(self):
        '''Desenha a pontuacao na tela e o nivel na tela'''
